...
interface AuthState {
  ...
  appVersion: string
  hasMapsKey: boolean
  /** An AMap (高德) Web-Service key is configured instance-wide. */
  hasAmapKey: boolean
  /** Admin switch: place search routes through AMap by default. */
  amapSearchEnabled: boolean
  ...
  setAmapSearchEnabled: (val: boolean) => void
...
export const useAuthStore = create<AuthState>()(
  ...
  setAmapSearchEnabled: (val: boolean) => set({ amapSearchEnabled: val }),
