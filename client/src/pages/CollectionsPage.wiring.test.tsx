...
vi.mock('../components/Collections/ListsRail', () => ({
  default: (p: {
    ...
    <div data-testid="rail">
      <button type="button" onClick={() => p.onSelect(2)}>
        rail-select
      </button>
      <button type="button" onClick={p.onNewList}>
        rail-new
      </button>
      <button type="button" onClick={() => p.onAcceptInvite(3)}>
        rail-accept
      </button>
      <button type="button" onClick={() => p.onDeclineInvite(3)}>
        rail-decline
      </button>
    </div>
  ),
...
vi.mock('../components/Collections/CollectionList', () => ({
  default: (p: {
    ...
    <div data-testid="list">
      ...
      <button type="button" onClick={() => p.onOpenPlace(10)}>
        list-open
      </button>
    </div>
  ),
...
vi.mock('../components/Collections/CollectionFilterBar', () => ({
  default: (p: {
    ...
    <div data-testid="filterbar">
      ...
      {p.canAddPlace && (
        <button type="button" onClick={p.onAddPlace}>
          filter-add
        </button>
      )}
      <button type="button" onClick={p.onManageLabels}>
        filter-labels
      </button>
      <button type="button" onClick={p.onToggleSelect}>
        filter-select
      </button>
    </div>
  ),
...
vi.mock('../components/Collections/CollectionMapPanel', () => ({
  default: (p: {
    ...
    <div data-testid={p.overlay ? 'map-overlay' : 'map-plain'}>
      ...
      <button type="button" onClick={() => p.onSelect(10)}>
        map-select
      </button>
      <button type="button" onClick={p.onDeselect}>
        map-deselect
      </button>
      <button type="button" onClick={p.onToggleView}>
        map-toggle
      </button>
      <button type="button" onClick={() => p.onSearch('cafe')}>
        map-search
      </button>
    </div>
  ),
...
vi.mock('../components/Collections/MoveToListModal', () => ({
  default: (p: {
    ...
    <div data-testid="move-modal">
      ...
      <button type="button" onClick={() => p.onPick(9)}>
        move-pick
      </button>
      <button type="button" onClick={p.onClose}>
        move-close
  ...
  default: (p: { isOpen: boolean; onClose: () => void; onAfterLeave: () => void }) =>
    p.isOpen ? (
      <div data-testid="share-modal">
        ...
        <button type="button" onClick={p.onAfterLeave}>
          share-leave
        </button>
      </div>
    ) : null,
...
vi.mock('../components/Collections/AddPlaceToCollectionModal', () => ({
  default: (p: { isOpen: boolean; collectionId: number; onClose: () => void; onAdded: () => void }) =>
    p.isOpen ? (
      <div data-testid="addplace-modal">
        {p.collectionId}
        <button type="button" onClick={p.onClose}>
          addplace-close
        </button>
        <button type="button" onClick={p.onAdded}>
          addplace-added
        </button>
      </div>
    ) : null,
...
vi.mock('../components/Collections/CollectionPlaceDetail', () => ({
  default: (p: {
    ...
    <div data-testid="detail">
      ...
      <button type="button" onClick={() => p.onSetStatus('visited')}>
        detail-status
      </button>
      <button type="button" onClick={() => p.onSave({ notes: 'hi' })}>
        detail-save
      </button>
      <button type="button" onClick={() => p.onUploadImage(new File(['x'], 'a.png'))}>
        detail-upload
      </button>
      <button type="button" onClick={p.onCopyToTrip}>
        detail-copy
      </button>
      <button type="button" onClick={p.onRemove}>
        detail-remove
      </button>
      <button type="button" onClick={() => p.onRate(4)}>
        detail-rate
      </button>
    </div>
  ),
...
vi.mock('../components/Collections/ListEditorModal', () => ({
  default: (p: {
    ...
    <div data-testid="editor">
      ...
      <button type="button" onClick={() => p.onCreated(77)}>
        editor-created
      </button>
      <button type="button" onClick={() => p.onRequestDelete(5)}>
        editor-delete
      </button>
    </div>
  ),
...
vi.mock('../components/Collections/LabelManager', () => ({
  default: (p: {
    ...
    onUpdate: (id: number, b: Record<string, unknown>) => void;
    onDelete: (id: number) => void;
    onClose: () => void;
  }) =>
    p.isOpen ? (
      <div data-testid="label-manager">
        <button type="button" onClick={() => p.onCreate('Food')}>
          label-create
        </button>
        <button type="button" onClick={() => p.onUpdate(1, { name: 'x' })}>
          label-update
        </button>
        <button type="button" onClick={() => p.onDelete(1)}>
          label-delete
        </button>
        <button type="button" onClick={p.onClose}>
          label-close
  ...
  default: (p: {
    ...
    p.isOpen ? (
      <div data-testid="bulk-labels">
        ...
        <button type="button" onClick={() => p.onAssign([1])}>
          bulk-assign
        </button>
