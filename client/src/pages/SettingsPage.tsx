import { Bell, Blocks, CloudOff, Info, Map, Paintbrush, Plug, Settings, SlidersHorizontal, User } from 'lucide-react';
            ...
            appVersion ? (
              managed ? (
                ...
                <a
                  ...
                  className="text-content-faint no-underline hover:text-content-secondary"
                >
                  v{appVersion}
                </a>
              ) : (
