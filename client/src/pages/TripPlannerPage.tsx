            ...
            >
              <button
                ...
                style={{
                  ...
                  background: leftHidden ? '#000' : 'var(--sidebar-bg)',
                  backdropFilter: 'blur(20px)',
                  WebkitBackdropFilter: 'blur(20px)',
                  boxShadow: leftHidden ? '0 2px 12px rgba(0,0,0,0.2)' : 'none',
                  border: 'none',
                  cursor: 'pointer',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  color: leftHidden ? '#fff' : 'var(--text-faint)',
                  transition: 'color 0.15s',
                }}
                onMouseEnter={(e) => {
                  if (!leftHidden) e.currentTarget.style.color = 'var(--text-primary)';
                }}
                onMouseLeave={(e) => {
                  if (!leftHidden) e.currentTarget.style.color = 'var(--text-faint)';
                }}
              >
            ...
            >
              <button
                ...
                style={{
                  ...
                  background: rightHidden ? '#000' : 'var(--sidebar-bg)',
                  backdropFilter: 'blur(20px)',
                  WebkitBackdropFilter: 'blur(20px)',
                  boxShadow: rightHidden ? '0 2px 12px rgba(0,0,0,0.2)' : 'none',
                  border: 'none',
                  cursor: 'pointer',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  color: rightHidden ? '#fff' : 'var(--text-faint)',
                  transition: 'color 0.15s',
                }}
                onMouseEnter={(e) => {
                  if (!rightHidden) e.currentTarget.style.color = 'var(--text-primary)';
                }}
                onMouseLeave={(e) => {
                  if (!rightHidden) e.currentTarget.style.color = 'var(--text-faint)';
                }}
              >
