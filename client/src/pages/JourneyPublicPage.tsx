...
import JourneyMapAuto from '../components/Journey/JourneyMapAuto';
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      >
        ...
        >
          <img src="/icons/icon-white.svg" alt={PRODUCT_NAME} width={26} height={26} />
        </div>
        ...
        <div className="mx-auto max-w-[900px] px-4 py-6 md:px-8">
          ...
          {view === 'map' && perms.share_map && (
            <div className="overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-700">
              <JourneyMapAuto checkins={[]} entries={sidebarMapItems as any} photos={photoLayer} height={500} cartoApiKey={cartoApiKey} />
            </div>
          )}
        </div>
      )}
      ...
      <div className="flex flex-col items-center gap-2 py-8">
        ...
        >
          <img src="/icons/icon.svg" alt={PRODUCT_NAME} width={18} height={18} style={{ borderRadius: 4 }} />
          <span style={{ fontSize: 'calc(11px * var(--fs-scale-caption, 1))', color: '#9ca3af' }}>
            {t('journey.public.sharedVia')} <strong style={{ color: '#6b7280' }}>{PRODUCT_NAME}</strong>
          </span>
        </div>
