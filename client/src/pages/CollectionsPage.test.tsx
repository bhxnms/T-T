...
function makeHook(overrides: Record<string, unknown> = {}) {
  ...
  return {
    ...
    setLabelFilter: noop,
    setSearch: noop,
    setSelectedPlaceId: noop,
    setSelectMode: noop,
    toggleSelect: noop,
    updatePlace: noop,
    showLabelManager: false,
    setShowLabelManager: noop,
    labelPickerOpen: false,
    setLabelPickerOpen: noop,
    handleCreateLabel: noop,
    handleUpdateLabel: noop,
    handleDeleteLabel: noop,
    handleBulkAssignLabels: noop,
    handleAssignPlaceLabels: noop,
    editorTarget: null,
    setEditorTarget: noop,
    handleEditorCreated: noop,
    showAddPlace: false,
    setShowAddPlace: noop,
    handlePlaceAdded: noop,
    confirmDeleteList: null,
    setConfirmDeleteList: noop,
    mobileRailOpen: false,
    setMobileRailOpen: noop,
    showShare: false,
    setShowShare: noop,
    handleAfterLeave: noop,
    selectedPlace: null,
    detailPlace: null,
    detailCategories: [],
    handleCloseDetail: noop,
    handleDetailStatus: noop,
    handleDetailRemove: noop,
    copyIds: null,
    openCopyForSelectedPlace: noop,
    openCopyForSelection: noop,
    closeCopy: noop,
    handleCopyToTrip: noop,
    ...
    handleDeclineInvite: noop,
    allVisibleSelected: false,
    handleSelectAll: noop,
    listPickerMode: null,
    setListPickerMode: noop,
    handleMoveToList: noop,
    handleDuplicateToList: noop,
    ...overrides,
  };
}
