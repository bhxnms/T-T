...
// The takeoff overlay renders the animated particle field, which starts a
// requestAnimationFrame loop the moment it mounts. Nothing here asserts on the
// animation (ParticleField has its own tests), but under the load of the full
// suite those loops pushed the overlay assertions past waitFor's default
// timeout and made FE-PAGE-LOGIN-014 fail intermittently in CI.
vi.mock('./login/ParticleField', () => ({ default: () => null }));
