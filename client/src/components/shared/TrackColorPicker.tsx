  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <button
        ...
        className={`grid h-7 w-7 place-items-center rounded-full border-2 transition-transform duration-150 hover:scale-110 focus-visible:outline-2 focus-visible:outline-[var(--accent)] motion-reduce:transition-none motion-reduce:hover:scale-100 ${
          value !== null && !isPreset
            ? `border-transparent ${selected}`
            : 'border-dashed border-edge-secondary hover:border-edge'
        }`}
