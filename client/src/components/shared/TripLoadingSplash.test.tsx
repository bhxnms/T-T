...
vi.mock('../../mobile/components/MDancingTT', () => ({
...
describe('TripLoadingSplash', () => {
  ...
  it('FE-W4TLS-002: falls back to the TT wordmark without a title', () => {
    render(<TripLoadingSplash />);

    expect(screen.getByRole('status')).toHaveAttribute('aria-label', 'TT');
