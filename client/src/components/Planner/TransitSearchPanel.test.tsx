...
import { buildDay, buildPlace, buildUser } from '../../../tests/helpers/factories';
...
const ITINERARY = {
  ...
  legs: [
    {
      mode: 'WALK',
      from: { name: 'Start', lat: 52.52, lng: 13.4, time: '2025-06-01T06:30:00Z', scheduledTime: null, track: null },
      to: {
        name: 'Alexanderplatz',
        lat: 52.521,
        lng: 13.41,
        time: '2025-06-01T06:34:00Z',
        scheduledTime: null,
        track: null,
      },
      duration: 240,
...
const WALK_BRACKETED = {
  ...
  legs: [
    {
      mode: 'WALK',
      from: stop('Aachen, Bushof', 50.777, 6.09, '2025-06-01T06:30:00Z'),
      to: stop('Aachen Hbf', 50.768, 6.091, '2025-06-01T06:34:00Z'),
      duration: 240,
      distance: 300,
      headsign: null,
      line: null,
    ...
    {
      mode: 'HIGHSPEED_RAIL',
      from: stop('Aachen Hbf', 50.768, 6.091, '2025-06-01T06:40:00Z', '2'),
      to: stop('Koeln Hbf', 50.943, 6.959, '2025-06-01T07:30:00Z'),
      duration: 3000,
      distance: null,
      headsign: 'Koeln',
      line: 'ICE 10',
    ...
    {
      mode: 'WALK',
      from: stop('Koeln Hbf', 50.943, 6.959, '2025-06-01T07:32:00Z'),
      to: stop('Koeln Messe/Deutz', 50.941, 6.974, '2025-06-01T07:40:00Z'),
      duration: 480,
      distance: 600,
      headsign: null,
      line: null,
    ...
    {
      mode: 'HIGHSPEED_RAIL',
      from: stop('Koeln Messe/Deutz', 50.941, 6.974, '2025-06-01T07:50:00Z', '11'),
      to: stop('Frankfurt(Main)Hbf', 50.107, 8.663, '2025-06-01T08:57:00Z'),
      duration: 4020,
      distance: null,
      headsign: 'Frankfurt',
      line: 'ICE 610',
    ...
    {
      mode: 'WALK',
      from: stop('Frankfurt(Main)Hbf', 50.107, 8.663, '2025-06-01T09:00:00Z'),
      to: stop('Frankfurt Flughafen Fernbf', 50.053, 8.57, '2025-06-01T09:10:00Z'),
      duration: 600,
      distance: 800,
      headsign: null,
      line: null,
...
async function pickFromAndTo(user: ReturnType<typeof userEvent.setup>) {
  ...
  transitApiMock.geocode.mockResolvedValueOnce({
    results: [{ name: 'Zoologischer Garten', lat: 52.507, lng: 13.332, type: 'STOP', area: 'Berlin' }],
  });
...
describe('TransitSearchPanel', () => {
  ...
  it('FE-PLANNER-TRANSIT-005: preference "fewer transfers" re-ranks the list', async () => {
    ...
    const direct = {
      ...ITINERARY,
      startTime: '2025-06-01T06:40:00Z',
      endTime: '2025-06-01T07:20:00Z',
      duration: 2400,
      transfers: 0,
    };
  ...
  async function pickFromAndLondon(user: ReturnType<typeof userEvent.setup>) {
    ...
    transitApiMock.geocode.mockResolvedValueOnce({
      results: [{ name: 'London Victoria', lat: 51.5074, lng: -0.1278, type: 'STOP', area: 'England' }],
    });
    await user.click(toInput);
  ...
  it('FE-PLANNER-TRANSIT-011: hovering a quick pick and a geocode result toggles the row background', async () => {
    ...
    transitApiMock.geocode.mockResolvedValueOnce({
      results: [{ name: 'Ostbahnhof', lat: 52.51, lng: 13.43, type: 'STOP', area: 'Berlin' }],
    });
    await user.click(toInput);
  ...
  it('FE-PLANNER-TRANSIT-017: "Less walking" ranks the least-walking itinerary first, "Best route" restores the original order', async () => {
    ...
    const lessWalking = {
      ...ITINERARY,
      startTime: '2025-06-01T06:45:00Z',
      endTime: '2025-06-01T07:25:00Z',
      walkSeconds: 60,
    };
  ...
  it('FE-PLANNER-TRANSIT-025: every transit mode gets its own line badge icon', async () => {
    ...
    const icon = (text: string) =>
      screen.getAllByText(text)[0].closest('span')?.querySelector('svg')?.getAttribute('class');
    ...
    const broken = {
      ...
      legs: [
        { ...ITINERARY.legs[1], from: { ...ITINERARY.legs[1].from, time: null } },
        {
          ...ITINERARY.legs[1],
          line: 'U5',
          from: { ...ITINERARY.legs[1].from, name: 'Frankfurter Tor', time: 'not-a-time' },
        },
      ],
    };
