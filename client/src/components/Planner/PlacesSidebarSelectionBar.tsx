import { Bookmark, Check, CheckCircle2, Loader2, Tag, Trash2 } from 'lucide-react';
    ...
    >
      ...
      <Tooltip label={t('places.changeCategory')} placement="bottom">
        <button
          ...
          onMouseEnter={(e) => {
            if (selectedIds.size > 0) e.currentTarget.style.background = 'var(--bg-hover)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = 'transparent';
          }}
