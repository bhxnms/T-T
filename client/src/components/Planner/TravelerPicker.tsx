...
function Avatar({
  ...
  return (
    <span
      style={{
        ...base,
        background: colorFor(userId).gradient,
        color: '#fff',
        display: 'grid',
        placeItems: 'center',
      ...
      {tripMembers.map((m) => {
        ...
        return (
          <button
            ...
            onMouseEnter={(e) => {
              if (!on) e.currentTarget.style.opacity = '0.85';
            }}
            onMouseLeave={(e) => {
 ...
 */
export function TravelerFilterAvatars({
  members,
  active,
  onToggle,
  label,
      ...
      {members.map((m) => {
        ...
        return (
          <button
            ...
            onMouseEnter={(e) => {
              if (!on) e.currentTarget.style.opacity = dim ? '0.7' : '0.82';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.opacity = dim ? '0.4' : '1';
            }}
          >
            <span
              style={{
            ...
            {on && (
              <span
                style={{
                  ...
                  display: 'grid',
                  placeItems: 'center',
                  boxShadow: '0 0 0 1.5px var(--bg-tertiary)',
                }}
              >
