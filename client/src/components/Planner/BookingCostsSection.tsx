...
export function BookingCostsSection({
      ...
      <div>
        ...
        >
          ...
          <span
            ...
            style={{ fontSize: 'calc(14px * var(--fs-scale-body, 1))', fontWeight: 700, flexShrink: 0 }}
          >
  ...
  return (
    <div>
      ...
      <div className="text-content-faint" style={{ fontSize: 'calc(11px * var(--fs-scale-caption, 1))', marginTop: 6 }}>
        {t(hintKey)}
      </div>
    </div>
  );
