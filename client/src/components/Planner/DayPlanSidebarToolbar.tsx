  ...
  return (
    <div className="border-b border-edge-faint" style={{ padding: '12px 16px', flexShrink: 0 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 8 }}>
        ...
        {onToggleAllConnections &&
          reservations.some(isRoutableReservation) &&
          (() => {
            ...
            return (
              <Tooltip label={label} placement="bottom">
                <button
                  ...
                  onMouseEnter={(e) => {
                    if (!allConnectionsShown) e.currentTarget.style.background = 'var(--bg-hover)';
                  }}
                  onMouseLeave={(e) => {
                    if (!allConnectionsShown) e.currentTarget.style.background = 'transparent';
                  }}
                >
