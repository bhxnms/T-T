...
export default function WeatherWidget({
  ...
  useEffect(() => {
    ...
    if (cached !== undefined && cached !== null) {
      ...
      const entry =
        cached.data !== undefined && typeof cached.fetchedAt === 'number' ? cached : { data: cached, fetchedAt: 0 };
  ...
  return (
    ...
    >
      ...
      {weather.description && (
        <span
          style={{ fontSize: 'calc(11px * var(--fs-scale-caption, 1))', color: '#9ca3af', textTransform: 'capitalize' }}
        >
          {weather.description}
        </span>
      )}
