...
import { calcPD, calcPP, calcPPD, hasCustomMemberSplit } from './BudgetPanel.helpers';
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <span style={{ fontSize: 'calc(13px * var(--fs-scale-body, 1))', fontWeight: 500, opacity: 0.9 }}>
                  ...
                  >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <InlineEditCell
                            ...
                            locale={locale}
                            editTooltip={
                              item.reservation_id ? t('budget.linkedToReservation') : t('budget.editTooltip')
                            }
                        ...
                        <InlineEditCell
                          ...
                          onSave={(v) =>
                            handleUpdateField(
                              item.id,
                              'persons',
                              v != null ? Number.parseInt(v as string) || null : null
                            )
                          }
                          style={{ textAlign: 'center' }}
                          placeholder="-"
                    ...
                    <td className="hidden sm:table-cell" style={{ ...td, textAlign: 'center' }}>
                      <InlineEditCell
                        ...
                        decimals={0}
                        onSave={(v) =>
                          handleUpdateField(item.id, 'days', v != null ? Number.parseInt(v as string) || null : null)
                        }
                        style={{ textAlign: 'center' }}
                        placeholder="-"
                        locale={locale}
