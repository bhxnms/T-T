    ...
    server.use(
      ...
      http.get('/api/trips/1/budget/settlement', () =>
        HttpResponse.json({
          ...
          flows: [
            {
              from: { user_id: 1, username: 'alice', avatar_url: null },
              to: { user_id: 2, username: 'bob', avatar_url: null },
              amount: 10,
            },
          ],
        })
    ...
    server.use(
      ...
      http.get('/api/trips/1/budget/settlement', () =>
        HttpResponse.json({
          ...
          flows: [
            {
              from: { user_id: 1, username: 'alice', avatar_url: '/uploads/avatars/alice.jpg' },
              to: { user_id: 2, username: 'bob', avatar_url: null },
              amount: 30,
            },
          ],
