        ...
        {(() => {
          ...
          return (
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, letterSpacing: '-0.03em', lineHeight: 1 }}>
              ...
              {decimalPart && (
                <span style={{ fontSize: 'calc(22px * var(--fs-scale-title, 1))', fontWeight: 500, color: theme.sub }}>
                  {sep}
                  {decimalPart}
                </span>
              )}
              ...
              <div style={{ position: 'relative', display: 'flex', justifyContent: 'center', margin: '4px 0 16px' }}>
                ...
                >
                  ...
                  >
                    ...
                    {totalDec && (
                      <span
                        style={{ fontSize: 'calc(13px * var(--fs-scale-body, 1))', fontWeight: 500, color: theme.sub }}
                      >
                        {decimalSep}
                        {totalDec}
                      </span>
