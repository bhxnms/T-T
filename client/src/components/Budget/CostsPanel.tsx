...
export default function CostsPanel({ tripId, tripMembers = [] }: CostsPanelProps) {
  ...
  const categoryOptions = useMemo(
    () => [
      ...
      ...COST_CATEGORY_LIST.map((c) => ({
        value: c.key,
        label: t(c.labelKey),
        icon: <c.Icon size={14} style={{ color: c.color }} />,
      })),
    ],
    [t]
  );
  ...
  const dayOptions = useMemo(() => {
    const days = Array.from(new Set(budgetItems.map((e) => e.expense_date).filter(Boolean) as string[])).sort((a, b) =>
      b.localeCompare(a)
    );
  ...
  const filterControls = (
    <>
      ...
      <CustomSelect
        value={dayFilter}
        onChange={(v) => setDayFilter(String(v))}
        options={dayOptions}
        size="sm"
        searchable
        style={{ minWidth: 140 }}
  ...
  const dayFilterLabel = dayFilter
    ? (() => {
        try {
          return new Date(dayFilter + 'T00:00:00Z').toLocaleDateString(locale, {
            weekday: 'long',
            day: 'numeric',
            month: 'long',
            timeZone: 'UTC',
    ...
    >
      <div style={{ minWidth: 0 }}>
        <div
          ...
          style={{ fontSize: 'calc(15px * var(--fs-scale-subtitle, 1))', fontWeight: 700, letterSpacing: '-0.01em' }}
        >
          {dayFilterLabel}
        </div>
        <div className="text-content-muted" style={{ marginTop: 3, fontSize: 'calc(12px * var(--fs-scale-body, 1))' }}>
          {t('costs.expensesCount', { count: filtered.length })}
        </div>
      </div>
      <div
        className="text-content"
      ...
      >
        {bigMoney(dayFilterTotal, 15, 'var(--text-muted)')}
      </div>
    </div>
  ) : null;
      ...
      {isMobile ? (
        ...
        <div style={{ maxWidth: '100%', margin: '0 auto' }}>
          ...
          >
            ...
            />
            <SummaryCard
              label={t('costs.outstanding')}
              sub={t('costs.outstandingSub')}
            ...
            <div>
              ...
              >
                <h3
                  className="text-content"
                  style={{
                    fontSize: 'calc(24px * var(--fs-scale-title, 1))',
                    fontWeight: 600,
                ...
                <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button
                    ...
                    className="border border-edge bg-surface-input text-content-muted disabled:opacity-40"
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
  ...
  function loadFailed() {
    return (
      <div
        className="text-content-muted"
        style={{ textAlign: 'center', padding: '14px 8px', fontSize: 'calc(12.5px * var(--fs-scale-body, 1))' }}
      >
    ...
    if (flows.length === 0)
      return (
        <div style={{ textAlign: 'center', padding: '14px 8px' }}>
          ...
          <div className="text-content" style={{ fontSize: 'calc(14.5px * var(--fs-scale-body, 1))', fontWeight: 600 }}>
            {t('costs.everyoneSquare')}
          </div>
          <div
            className="text-content-faint"
            style={{ fontSize: 'calc(12px * var(--fs-scale-body, 1))', marginTop: 2 }}
          >
        ...
        {flows.map((f, i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
              <span
                className="text-content"
                style={{ fontSize: 'calc(14px * var(--fs-scale-body, 1))', fontWeight: 700 }}
              >
                {fmt(f.amount)}
              </span>
              {canEdit && (
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16, paddingTop: 8 }}>
        ...
        >
          ...
          <div
            style={{
              fontSize: 'calc(44px * var(--fs-scale-title, 1))',
              fontWeight: 700,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          <div className={cardCls} style={{ borderRadius: 18, padding: 16 }}>
            ...
            <div
              className="text-content"
              style={{ fontSize: 'calc(12.5px * var(--fs-scale-body, 1))', fontWeight: 600 }}
            >
              {t('costs.youOwe')}
            </div>
            <div className="text-content-faint" style={{ fontSize: 'calc(10.5px * var(--fs-scale-caption, 1))' }}>
              {t('costs.youOweSub')}
            </div>
            <div
              style={{
                fontSize: 'calc(27px * var(--fs-scale-title, 1))',
                fontWeight: 700,
        ...
        <div className={cardCls} style={{ borderRadius: 18, padding: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
            ...
            >
              {bigMoney(totals.outstanding, 16, 'var(--c-ink3)')}
            </div>
          </div>
        </div>
        ...
        <div className={cardCls} style={{ borderRadius: 18, padding: 16 }}>
          ...
          >
            <div
              className="text-content"
              style={{
                fontSize: 'calc(19px * var(--fs-scale-subtitle, 1))',
                fontWeight: 700,
                letterSpacing: '-0.02em',
                display: 'flex',
                alignItems: 'baseline',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
            ...
            <button
              ...
              title={t('budget.exportCsv')}
              disabled={!budgetItems.length}
              className="border border-edge bg-surface-card text-content-muted disabled:opacity-40"
              style={{
                display: 'inline-flex',
                alignItems: 'center',
                justifyContent: 'center',
          ...
          {dayGroups.length === 0 ? (
            <div
              className="text-content-faint"
              style={{ textAlign: 'center', padding: '36px 16px', fontSize: 'calc(13px * var(--fs-scale-body, 1))' }}
            >
  ...
  function RowActions({
    ...
    return (
      <div
        className="exp-actions border border-edge bg-surface-card"
        style={{
          display: 'flex',
      ...
      >
        <button
          ...
          title={t('common.edit')}
          onClick={onEdit}
          className="text-content-muted transition-colors"
          style={btn}
        >
          <Pencil size={13} />
        </button>
        <button
          ...
          title={deleteLabel}
          onClick={onDelete}
          className="exp-action-danger transition-colors"
      ...
      <div style={{ display: 'flex', alignItems: 'stretch', gap: 8 }}>
        <div
          ...
          style={{
            ...
            alignItems: 'center',
            borderRadius: 18,
            padding: isMobile ? '16px 20px' : '20px 20px 16px',
          }}
        >
          ...
          {!isMobile &&
            (note ? (
              <button
                type="button"
                onClick={() => setExpandedNoteId(open ? null : e.id)}
                aria-expanded={open}
                title={open ? t('costs.hideNote') : t('costs.showNote')}
                className="exp-note-btn border border-edge bg-surface-secondary text-content-muted transition-colors hover:border-content-faint hover:text-content"
                style={{
                  display: 'flex',
                  ...
                  minWidth: 0,
                  width: '100%',
                  padding: open ? '10px 14px 11px 13px' : '7px 12px 7px 11px',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, alignSelf: 'center' }}>
            <div
              style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4, whiteSpace: 'nowrap' }}
            >
              <span
                ...
                style={{
                  ...
                  fontSize: isMobile
                    ? 'calc(18px * var(--fs-scale-subtitle, 1))'
                    : 'calc(15px * var(--fs-scale-subtitle, 1))',
                  fontWeight: 700,
              ...
              {!unfinished && (e.members || []).length > 0 && Math.abs(net) > 0.01 && (
                <span
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    padding: isMobile ? 0 : '2px 9px',
                    borderRadius: 999,
                    background: isMobile ? 'none' : net > 0 ? 'rgba(22,163,74,0.13)' : 'rgba(220,38,38,0.13)',
                    fontSize: 'calc(11.5px * var(--fs-scale-caption, 1))',
                    fontWeight: 600,
      ...
      <div style={{ display: 'flex', alignItems: 'stretch', gap: 8 }}>
        <div
          ...
          style={{
            ...
            minWidth: 0,
            display: 'grid',
            gridTemplateColumns: isMobile ? '46px 1fr auto' : '46px minmax(200px, 1fr) minmax(0, 1.5fr) auto',
            gap: isMobile ? 16 : 18,
            alignItems: 'center',
            borderRadius: 18,
            padding: '16px 20px',
  ...
  function CategoryBreakdown() {
    ...
    if (rows.length === 0)
      return (
        <div className="text-content-faint" style={{ fontSize: 'calc(12.5px * var(--fs-scale-body, 1))' }}>
...
function SummaryCard({
  ...
  tone: 'owe' | 'owed' | 'total' | 'unfinished';
}) {
  const total = tone === 'total';
  const accent =
    tone === 'owe' ? '#dc2626' : tone === 'owed' ? '#16a34a' : tone === 'unfinished' ? '#d97706' : undefined;
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
        ...
        <div>
          <div
            style={{ fontSize: 'calc(13px * var(--fs-scale-body, 1))', fontWeight: 600 }}
            className={total ? '' : 'text-content'}
          >
            {label}
          </div>
          <div
            style={{ fontSize: 'calc(12px * var(--fs-scale-body, 1))', opacity: total ? 0.6 : 1 }}
            className={total ? '' : 'text-content-faint'}
          >
            {sub}
          </div>
        </div>
      ...
      <div
        style={{
          fontSize: 'calc(46px * var(--fs-scale-title, 1))',
          fontWeight: 600,
            ...
            <div>
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: 10,
                  padding: '0 12px',
                  opacity: isTicketMode ? 0.6 : 1,
                }}
              >
                <span className="text-content-faint" style={{ fontSize: 'calc(15px * var(--fs-scale-subtitle, 1))' }}>
                  {sym(currency)}
                </span>
                <NumericInput
                  mode="signed-decimal"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14, minWidth: 0 }}>
          ...
          <div className={panelCls}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
              ...
              <div
                className="border border-edge bg-surface-card"
                style={{ display: 'flex', borderRadius: 999, padding: 2 }}
              >
                <button
                  type="button"
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    border: 0,
                    background: splitMode === 'equally' ? undefined : 'none',
                    cursor: 'pointer',
                    fontFamily: 'inherit',
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    border: 0,
                    background: splitMode === 'custom' ? undefined : 'none',
                    cursor: 'pointer',
                    fontFamily: 'inherit',
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    border: 0,
                    background: splitMode === 'ticket' ? undefined : 'none',
                    cursor: 'pointer',
                    fontFamily: 'inherit',
                  }}
                >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {ticketItems.map((item, itemIdx) => (
                    <div
                      key={item.id}
                      className="border border-edge bg-surface-secondary"
                      style={{ padding: 10, borderRadius: 10, display: 'flex', flexDirection: 'column', gap: 8 }}
                    >
                      <div
                        style={{
                          display: 'grid',
                          ...
                          return (
                            <button
                              ...
                              style={{
                                ...
                                cursor: 'pointer',
                                fontFamily: 'inherit',
                                border: active ? '1px solid var(--text-primary)' : undefined,
                              }}
                            >
                              {p.avatar_url ? (
                                <img
          ...
          <div className={panelCls}>
            <label className={labelCls} htmlFor="expense-note">
              {t('costs.note')}
            </label>
            <textarea
              id="expense-note"
