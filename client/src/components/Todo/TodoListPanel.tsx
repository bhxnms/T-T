import { AlertCircle, Calendar, Check, CheckCheck, Flag, Inbox, Plus, Trash2, User, X } from 'lucide-react';
  ...
  return (
    <button
      ...
      style={{
        ...
        gap: compact ? 0 : 8,
        width: '100%',
        padding: compact ? '8px 0' : '7px 12px',
        border: 'none',
        borderRadius: 8,
        cursor: 'pointer',
        fontFamily: 'inherit',
    ...
    <div style={{ display: 'flex', height: 'calc(100vh - 180px)', minHeight: 400 }}>
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontWeight: sortByDue ? 600 : 400,
            transition: 'all 0.1s',
          }}
          onMouseEnter={(e) => {
            if (!sortByDue) e.currentTarget.style.background = 'var(--bg-hover)';
          }}
          onMouseLeave={(e) => {
            if (!sortByDue) e.currentTarget.style.background = 'transparent';
          }}
        >
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '4px 0' }}>
          {filtered.length === 0 ? (
            <EmptyState scene="tasks" title={t('todo.empty')} />
          ) : (
            filtered.map((item) => {
