...
import { CheckinCard, EntryCard, SkeletonCard } from './JourneyDetailPageEntryCard';
...
describe('EntryCard', () => {
  ...
  it('FE-JRN-CARD-010: skips the plugin request while no plugins are active', async () => {
    let called = 0;
    server.use(
      http.get('/api/journal-entry-rows/10', () => {
        called += 1;
          ...
          providers: [
            {
              ...
              items: [
                ...
                { label: 'Shop', value: 'Sant Eustachio', url: 'https://example.com' },
              ],
            },
