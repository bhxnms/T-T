      ...
      <div
        className={
          embedded
            ...
            : 'flex max-h-[calc(100dvh-var(--bottom-nav-h)-20px)] w-full max-w-[720px] flex-col overflow-hidden rounded-t-2xl bg-white shadow-[0_20px_40px_rgba(0,0,0,0.2)] dark:bg-zinc-900 md:max-h-[85vh] md:max-w-[960px] md:rounded-2xl'
        }
