                ...
                {!user?.mfa_enabled && mfaQr && (
                  <div className="space-y-3">
                    ...
                    <img
                      ...
                      alt="MFA QR code"
                      className="block h-[250px] w-[250px]"
                    />
                    <div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {(user as UserWithOidc)?.oidc_issuer && (
              ...
              >
                ...
                {stripTrailingSlashes((user as UserWithOidc).oidc_issuer!.replace('https://', ''))}
              </p>
            )}
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <p
              ...
              style={{ fontSize: 'calc(13px * var(--fs-scale-body, 1))', lineHeight: 1.6, margin: '0 0 20px' }}
            >
