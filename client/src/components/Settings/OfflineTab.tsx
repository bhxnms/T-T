      ...
      <Section title={t('settings.offline.mode.title')} icon={CloudOff}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ borderTop: '1px solid var(--border-secondary, #e5e7eb)', paddingTop: 16 }}>
            <div
              style={{ fontWeight: 600, fontSize: 'calc(14px * var(--fs-scale-body, 1))', marginBottom: 4 }}
            ...
            <p
              ...
              style={{ fontSize: 'calc(12px * var(--fs-scale-body, 1))', marginTop: 0, marginBottom: 12 }}
            >
            ...
            {preparing && progress && (
              <div style={{ marginTop: 12 }}>
                ...
                <div
                  className="text-content-muted"
                  style={{ fontSize: 'calc(11px * var(--fs-scale-caption, 1))', marginTop: 4 }}
                >
                  {progressLabel}
            ...
            {!preparing && notice && notice.kind !== 'load-failed' && (
              <div
                style={{
                  ...
                  marginTop: 10,
                  color: isOfflineNoticeWarning(notice) ? 'var(--warning)' : 'var(--success)',
                }}
              >
      ...
      <Section title={t('settings.offline.storage.title')} icon={MapIcon}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {allTrips.length > 0 && (
            <div style={{ borderTop: '1px solid var(--border-secondary, #e5e7eb)', paddingTop: 16 }}>
              <div
                style={{ fontWeight: 600, fontSize: 'calc(13px * var(--fs-scale-body, 1))', marginBottom: 8 }}
                className="text-content"
              >
                  ...
                  return (
                    ...
                    >
                      <div style={{ minWidth: 0 }}>
                        ...
                        <div
                          className="text-content-muted"
                          style={{ fontSize: 'calc(11px * var(--fs-scale-caption, 1))' }}
                        >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button
              type="button"
              onClick={() => {
                if (window.confirm(t('settings.offline.clearConfirm'))) void handleClear();
              }}
...
function Row({ label, hint, control }: { label: string; hint?: string; control: React.ReactNode }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16 }}>
      <div style={{ minWidth: 0 }}>
        <div className="text-content" style={{ fontWeight: 500, fontSize: 'calc(14px * var(--fs-scale-body, 1))' }}>
          {label}
        </div>
        {hint && (
          <div
...
function Stat({ label, value, danger }: { label: string; value: number; danger?: boolean }) {
  return (
    <div
      className="border border-edge bg-surface-secondary"
      style={{ padding: '8px 14px', borderRadius: 8, minWidth: 100 }}
    >
      <div
        style={{
