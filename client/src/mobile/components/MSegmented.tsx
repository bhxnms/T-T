...
export default function MSegmented<T extends string = string>({
  ...
  return (
    ...
    >
      {indicator && (
        <div
          className="absolute bottom-[3px] top-[3px] rounded-full bg-m-act transition-[left,width] duration-[280ms] ease-[var(--ease-drawer)]"
        ...
        return (
          <button
            ...
            className={`relative z-[1] rounded-full py-[7px] text-center ${
              variant === 'intrinsic' ? 'whitespace-nowrap px-[13px] text-[0.75rem]' : 'flex-1 text-[0.71875rem]'
