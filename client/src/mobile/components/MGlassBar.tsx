...
export default function MGlassBar({ floating = true, className = '', children }: MGlassBarProps) {
  return (
    <div
      className={`flex items-center gap-[11px] rounded-full border border-[color:var(--m-gbr)] bg-[color:var(--m-glass)] px-[14px] py-2 shadow-[0_14px_34px_-16px_rgba(0,0,0,.22)] backdrop-blur-[26px] backdrop-saturate-[1.7] ${
