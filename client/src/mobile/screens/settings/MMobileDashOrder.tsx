 ...
 */
export default function MMobileDashOrder({
  cfg,
  onChange,
}: {
  ...
  return (
    <div className="flex flex-col gap-[6px]">
      {order.map((id, i) => (
        <div
          key={id}
          className="flex items-center gap-[10px] rounded-xl border border-[color:var(--m-rowbr)] bg-[color:var(--m-sheet)] px-3 py-[10px]"
        >
