...
export default function MSettingsMap() {
  ...
  const save = async (): Promise<void> => {
    ...
    try {
      ...
      const stylePatch = provider === 'maplibre-gl' ? { maplibre_style: glStyle } : provider === 'amap' ? {} : { mapbox_style: glStyle }
      ...
      {provider !== 'leaflet' && (
        <>
          ...
          <MSetInput
            ...
            placeholder={defaultStyleForProvider(provider === 'amap' ? 'maplibre-gl' : provider)}
          />
