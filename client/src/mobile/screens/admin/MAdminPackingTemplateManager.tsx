    ...
    <MAdminCard>
      ...
      {showCreate && (
        <div className="mt-2 flex items-center gap-2">
          ...
          <PkIconBtn ariaLabel={t('common.save')} variant="accent" onClick={handleCreateTemplate}>
            <Check size={15} />
          </PkIconBtn>
          <PkIconBtn ariaLabel={t('common.cancel')} onClick={() => setShowCreate(false)}>
            <X size={15} />
          </PkIconBtn>
        </div>
      )}
      ...
      {isLoading ? (
        ...
        <div className="py-8 text-center font-geist text-[0.75rem] text-m-faint">
                ...
                <div className="space-y-2 pb-3 pl-6">
                      ...
                      <div key={cat.id} className="overflow-hidden rounded-xl border border-[color:var(--m-rowbr)]">
                        ...
                        <div className="flex items-center gap-1.5 bg-[color:var(--m-ic)] px-3 py-2">
                          {editingCatId === cat.id ? (
                            ...
                            <span className="min-w-0 flex-1 truncate font-geist text-[0.625rem] font-bold uppercase tracking-wider text-m-muted">
                              {cat.name}
                            </span>
                          )}
                  ...
                  {addingCategory ? (
                    <div className="flex items-center gap-2">
                      ...
                      <PkIconBtn variant="accent" ariaLabel={t('common.save')} onClick={handleAddCategory}>
                        <Check size={15} />
                      </PkIconBtn>
                      <PkIconBtn
                        ariaLabel={t('common.cancel')}
