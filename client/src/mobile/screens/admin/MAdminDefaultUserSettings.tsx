...
export default function MAdminDefaultUserSettings(): React.ReactElement {
  ...
  const stylePresetLabel =
    glStylePresets.find((p) => p.url === mapboxStyle)?.name || t('admin.defaultSettings.mapboxStylePlaceholder');
        ...
        <div className="mt-2 space-y-[14px]">
          ...
          >
            <MSegmented
              ...
              onChange={(v) => save({ distance_unit: v as DistanceUnit })}
      ...
      <MAdminCard>
        ...
        <div className="mt-2 space-y-[14px]">
          ...
          <MAdminField
            label={
              <>
                {t('settings.mapTemplate')} <ResetButton field="map_tile_url" />
              </>
            }
          ...
          {!managed && (
            <MAdminField
              label={
                <>
                  {t('admin.defaultSettings.cartoKey')} <ResetButton field="carto_api_key" />
                </>
              }
          ...
          <div className="border-t border-[color:var(--m-rowbr)] pt-[14px]">
            ...
            >
              <MSegmented
                value={mapProvider}
                onChange={(v) => saveMapProvider(v as MapProvider)}
            ...
            <div className="space-y-[14px]">
              {mapProvider === 'mapbox-gl' && !managed && (
                <MAdminField
                  label={
                    <>
                      {t('admin.defaultSettings.mapboxToken')} <ResetButton field="mapbox_access_token" />
                    </>
                  }
              ...
              <MAdminField
                label={
                  <>
                    {t('admin.defaultSettings.mapboxStyle')} <ResetButton field={styleKey} />
                  </>
                }
              >
