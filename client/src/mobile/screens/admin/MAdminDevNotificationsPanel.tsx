  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        <span className="rounded bg-[color:var(--m-st-pending)] px-2 py-[3px] font-mono text-[0.625rem] font-bold text-white">
          DEV ONLY
        </span>
        <span className="text-[0.8125rem] font-bold text-m-ink">Notification Testing</span>
      </div>

      {/* ── Type Testing ─────────────────────────────────────────────────── */}
      <MAdminCard>
        <MAdminCardHead title="Type Testing" hint="Test how each in-app notification type renders, sent to yourself." />
      ...
      {users.length > 0 && (
        <MAdminCard>
          <MAdminCardHead title="User-Scoped Events" hint="Fires each user event to the selected recipient." />
          <div className="mt-2">
            <select
      ...
      {/* ── Admin-Scoped Events ──────────────────────────────────────────── */}
      <MAdminCard>
        <MAdminCardHead title="Admin-Scoped Events" hint="Fires to all admin users." />
        <div className="mt-2 grid grid-cols-1 gap-2">
          <Btn
            sending={sending}
