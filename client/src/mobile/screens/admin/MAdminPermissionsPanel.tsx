  ...
  return (
    <MAdminCard>
      <div className="mb-1 flex items-center gap-2">
        ...
        <MAdminButton variant="ghost" disabled={saving} title={t('perm.resetDefaults')} onClick={handleReset}>
      ...
      <div>
        {CATEGORIES.map((cat) => (
          <div key={cat.id} className="mt-3 border-t border-[color:var(--m-rowbr)] pt-3">
