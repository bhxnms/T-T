            ...
            {isOwner && (
              <div className="flex flex-col gap-[6px]">
                <div className="flex gap-[6px]">
                  <button
                    type="button"
                    onClick={() => setSharing('common', [])}
                    className={pillCls(visibility === 'common')}
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setSharing('personal', [])}
                    className={pillCls(visibility === 'personal')}
                  >
                ...
                <div className="flex flex-col gap-1 rounded-[12px] border border-[color:var(--m-rowbr)] bg-[color:var(--m-ic)] p-[6px]">
                  {others.length === 0 ? (
                    <div className="px-2 py-1 font-geist text-[0.6875rem] text-m-faint">
