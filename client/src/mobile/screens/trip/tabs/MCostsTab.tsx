      ...
      {groups.length === 0 &&
        (budgetItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <MDancingTT scene="costs" className="mb-2" />
      ...
      >
        ...
        {note && (
          ...
          >
            ...
            <span
              className={`min-w-0 flex-1 text-[0.6875rem] leading-[1.5] text-m-muted ${noteOpen ? 'whitespace-pre-wrap [overflow-wrap:anywhere]' : 'truncate'}`}
            >
              {note}
            </span>
            <ChevronDown
