...
/**
 * Trip-open splash — the TT mascot acts out a little journey while the trip
 ...
 */
const STEPS: { scene: TTScene; key: string }[] = [
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[color:var(--m-bg)] bg-[image:var(--m-scr)] text-m-ink">
      ...
      <div className="mb-6 flex h-[140px] w-[150px] items-center justify-center overflow-hidden">
        ...
        >
          <MDancingTT scene={step.scene} mood="happy" size={124} />
        </div>
      </div>

      <div className="mb-2 text-[1.25rem] font-bold tracking-[-0.3px]">{title || 'TT'}</div>
