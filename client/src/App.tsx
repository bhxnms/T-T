      ...
      .then(
        async (config: {
          ...
          if (config?.amap_js_key)
            (window as Window & { __TREK_AMAP_JS_KEY__?: string }).__TREK_AMAP_JS_KEY__ = config.amap_js_key;
          ...
          if (version && version === reportedVersion) {
            ...
            try {
              localStorage.setItem('trek_app_version', version);
            } catch {
              /* site data blocked */
            }
