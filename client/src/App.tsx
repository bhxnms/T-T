...
export default function App() {
  const { loadUser, isAuthenticated, demoMode, setManaged, setDemoMode, setDevMode, setIsPrerelease, setAppVersion, setHasMapsKey, setHasAmapKey, setAmapSearchEnabled, setServerTimezone, setAppRequireMfa, setTripRemindersEnabled, setPlacesPhotosEnabled, setPlacesAutocompleteEnabled, setPlacesDetailsEnabled, setPlacesEnrichEnabled } = useAuthStore()
  ...
  useEffect(() => {
    ...
    authApi.getAppConfig().then(async (config: { managed?: boolean; demo_mode?: boolean; dev_mode?: boolean; is_prerelease?: boolean; has_maps_key?: boolean; has_amap_key?: boolean; amap_js_key?: string; amap_search_enabled?: boolean; version?: string; timezone?: string; require_mfa?: boolean; trip_reminders_enabled?: boolean; places_photos_enabled?: boolean; places_autocomplete_enabled?: boolean; places_details_enabled?: boolean; places_enrich_enabled?: boolean; permissions?: Record<string, PermissionLevel> }) => {
      ...
      if (config?.amap_js_key) (window as Window & { __TREK_AMAP_JS_KEY__?: string }).__TREK_AMAP_JS_KEY__ = config.amap_js_key
      if (config?.amap_search_enabled !== undefined) setAmapSearchEnabled(!!config.amap_search_enabled)
