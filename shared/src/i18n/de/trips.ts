...
const trips: TranslationStrings = {
  ...
  "trips.importTrekIntro": "Lade ein TREK-Backup (.zip) hoch und wähle die Reisen, die nach TT kopiert werden sollen — Tage, Orte, Buchungen, Budget und Fotos kommen mit.",
