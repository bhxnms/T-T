...
const atlas: TranslationStrings = {
  ...
  'atlas.checkinTab': 'Check-ins',
  'atlas.checkinTotal': 'Check-ins',
  'atlas.checkinLandmarks': 'Landmarks',
  'atlas.checkinPlaces': 'Trip places',
  'atlas.checkinEmpty': 'No check-ins yet — tick a landmark or a trip place as visited',
