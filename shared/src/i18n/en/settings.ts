...
const settings: TranslationStrings = {
  ...
  'settings.mapPoiPillHintAmap':
    'Show a category pill on the trip map to find nearby restaurants, hotels and more from AMap.',
  ...
  'settings.about.descriptionManaged':
    'Tourism-Team helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place.',
