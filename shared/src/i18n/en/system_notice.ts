...
'system_notice.thank_you_support.title': 'Thank you for using TT',
  ...
  'system_notice.release_400.headline': 'TT project update',
  'system_notice.release_400.intro':
    'TT adds mobile planning and activity management. Nineteen people wrote this one — and about a hundred and fifty reported bugs went with it.',
  'system_notice.release_400.feature_mobile_title': 'TT goes mobile',
  'system_notice.release_400.feature_mobile_body':
    'Everything under 768px is its own interface now — a glass dock, its own sheets, its own trip planner. Open TT on your phone.',
  'system_notice.release_400.feature_studio_title': 'TT Studio',
  ...
  'system_notice.release_400.feature_places_body':
    'Pictures and a description fill themselves in before you save a place. And your uploads no longer have to live on the disk TT runs on.',
