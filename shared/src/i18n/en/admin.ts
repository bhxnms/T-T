...
const admin: TranslationStrings = {
  ...
  'admin.amapKey': 'AMap Web-Service Key',
  'admin.amapKeyHint': 'For Chinese place search and traffic-aware routing. Get a Web服务 key from lbs.amap.com.',
  'admin.amapSearch.title': 'Use AMap for place search',
  'admin.amapSearch.subtitle': 'Uses AMap by default; each place-search form can switch back to native TREK providers.',
  ...
  'admin.weather.description':
    'TT continues to use the TREK weather API — a free, open-source service with no API key required.',
