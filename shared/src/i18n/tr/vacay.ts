...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Tatil planınızı diğer Tourism-Team kullanıcılarıyla paylaşın',
  'vacay.owner': 'Sahibi',
  'vacay.shareEmailPlaceholder': 'Tourism-Team kullanıcısının e-postası',
  ...
  'vacay.inviteHint': 'Başka bir Tourism-Team kullanıcısını ortak bir tatil takvimi paylaşmaya davet edin.',
  ...
  'vacay.shareCalendarHint':
    'Başka bir Tourism-Team kullanıcısının tatil takviminizi görmesine izin verin. Yalnızca görüntüleme — birleştirme ve düzenleme yok.',
