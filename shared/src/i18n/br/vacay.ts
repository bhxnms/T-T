...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do Tourism-Team',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário Tourism-Team',
  ...
  'vacay.inviteHint': 'Convide outro usuário Tourism-Team para compartilhar um calendário de férias combinado.',
  ...
  'vacay.shareCalendarHint':
    'Permita que outro usuário Tourism-Team veja seu calendário de férias. Somente visualização — sem fusão, sem edição.',
