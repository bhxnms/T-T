...
const admin: TranslationStrings = {
  ...
  'admin.weather.description': 'O TT continua a usar a API de clima do TREK — um serviço gratuito e de código aberto, sem chave de API.',
  ...
  'admin.amapKey': 'Chave do serviço web AMap',
  'admin.amapKeyHint':
