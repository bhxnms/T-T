...
const trips: TranslationStrings = {
  ...
  "trips.importTrekIntro": "Töltsön fel egy TREK biztonsági mentést (.zip), és válassza ki a TT-be másolandó utakat — napok, helyek, foglalások, költségvetés és fényképek együtt jönnek.",
