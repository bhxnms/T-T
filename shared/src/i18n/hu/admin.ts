...
const admin: TranslationStrings = {
  ...
  "admin.amapKey": "AMap webszolgáltatási kulcs",
  "admin.amapKeyHint": "Kínai helykereséshez és forgalomtudatos útvonaltervezéshez. Webszolgáltatási kulcs a lbs.amap.com oldalon szerezhető.",
  "admin.amapSearch.title": "AMap használata a helykereséshez",
  "admin.amapSearch.subtitle": "Alapértelmezetten AMap-ot használ; minden helykereső mező visszaválthat a TREK natív forrásaira.",
};
