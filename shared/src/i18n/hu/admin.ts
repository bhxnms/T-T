...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'A TT továbbra is a TREK időjárás API-ját használja — ingyenes, nyílt forráskódú szolgáltatás, API kulcs nélkül.',
  ...
  'admin.amapKeyHint':
    'Kínai helykereséshez és forgalomtudatos útvonaltervezéshez. Webszolgáltatási kulcs a lbs.amap.com oldalon szerezhető.',
