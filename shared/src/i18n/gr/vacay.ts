...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Μοιραστείτε το πλάνο διακοπών σας με άλλους χρήστες Tourism-Team',
  'vacay.owner': 'Κάτοχος',
  'vacay.shareEmailPlaceholder': 'Email χρήστη Tourism-Team',
  ...
  'vacay.inviteHint': 'Προσκαλέστε έναν άλλο χρήστη Tourism-Team για να μοιραστείτε ένα κοινό ημερολόγιο διακοπών.',
  ...
  'vacay.shareCalendarHint':
    'Επιτρέψτε σε έναν άλλο χρήστη Tourism-Team να βλέπει το ημερολόγιο διακοπών σας. Μόνο προβολή — χωρίς συγχώνευση, χωρίς επεξεργασία.',
