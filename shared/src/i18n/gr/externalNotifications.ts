...
const gr: NotificationLocale = {
  email: {
    footer: 'Λάβατε αυτό το μήνυμα επειδή έχετε ενεργοποιήσει τις ειδοποιήσεις στο Tourism-Team.',
    manage: 'Διαχείριση προτιμήσεων στις Ρυθμίσεις',
    madeWith: 'Δημιουργήθηκε με',
    openTrek: 'Άνοιγμα Tourism-Team',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `Ο/Η ${p.actor} σας προσκάλεσε να συγχωνεύσετε τα σχέδια διακοπών σας. Ανοίξτε το Tourism-Team για να αποδεχτείτε ή να απορρίψετε.`,
    }),
    vacay_share: (p) => ({
      title: 'Κοινοποίηση Ημερολογίου Vacay',
      body: `Ο/Η ${p.actor} κοινοποίησε το ημερολόγιο διακοπών του/της σε εσάς. Ανοίξτε το Tourism-Team για να το δείτε.`,
    }),
    collection_invite: (p) => ({
      title: 'Πρόσκληση σε συλλογή',
      body: `Ο/Η ${p.actor} σας προσκάλεσε να μοιραστείτε μια συλλογή. Ανοίξτε το Tourism-Team για να αποδεχτείτε ή να απορρίψετε.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Νέα έκδοση Tourism-Team διαθέσιμη',
      body: `Η έκδοση Tourism-Team ${p.version} είναι τώρα διαθέσιμη. Επισκεφθείτε τον πίνακα διαχείρισης για να ενημερώσετε.`,
    }),
    replica_failure: (p) => ({
  ...
  passwordReset: {
    ...
    greeting: 'Γεια σας',
    body: 'Λάβαμε ένα αίτημα επαναφοράς του κωδικού πρόσβασης για τον λογαριασμό σας στο Tourism-Team. Κάντε κλικ στο παρακάτω κουμπί για να ορίσετε νέο κωδικό πρόσβασης.',
