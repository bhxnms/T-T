...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями Tourism-Team',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя Tourism-Team',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя Tourism-Team для совместного календаря отпусков.',
  ...
  'vacay.shareCalendarHint':
    'Позвольте другому пользователю Tourism-Team видеть ваш календарь отпусков. Только просмотр — без объединения и редактирования.',
