...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами Tourism-Team',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача Tourism-Team',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача Tourism-Team для спільного календаря відпусток.',
  ...
  'vacay.shareCalendarHint':
    'Дозвольте іншому користувачу Tourism-Team бачити ваш календар відпусток. Лише перегляд — без об’єднання та редагування.',
