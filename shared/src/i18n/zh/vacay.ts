...
const vacay: TranslationStrings = {
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '与其他 Tourism-Team 用户共享你的假期计划',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'Tourism-Team 用户邮箱',
  ...
  'vacay.inviteHint': '邀请其他 Tourism-Team 用户共享合并的假期日历。',
  ...
  'vacay.shareCalendarHint': '让其他 Tourism-Team 用户查看你的假期日历。仅供查看——不合并、不可编辑。',
