...
const admin: TranslationStrings = {
  ...
  'admin.amapKey': '高德 Web 服务 API 密钥',
  'admin.amapKeyHint': '用于中国地点搜索和实时路况路线规划。在 lbs.amap.com 获取 Web 服务 Key。',
  'admin.amapSearch.title': '使用高德搜索地点',
  'admin.amapSearch.subtitle': '默认使用高德；每个地点搜索框仍可切换回 TREK 原生数据源。',
  ...
  'admin.tabs.tunnel': 'Cloudflare 隧道',
  'admin.tunnel.title': 'Cloudflare 隧道',
  'admin.tunnel.intro':
    '通过 Cloudflare 隧道把本实例发布到公网。只在你需要帮助搭建隧道时才开启——如果你已经自己运行 cloudflared、nginx 或 Caddy，请保持关闭，这里不会影响你现有的配置。',
  'admin.tunnel.enable': '启用 Cloudflare 隧道配置',
  'admin.tunnel.enableHint': '默认关闭。关闭期间本页不会读取或应用任何设置，你已有的隧道照常工作。',
  'admin.tunnel.disabledNotice': '此功能已关闭。你可以继续按原有方式配置隧道——下方设置仅在启用后才会保存。',
  'admin.tunnel.statusOn': '已启用',
  'admin.tunnel.statusOff': '已关闭',
  'admin.tunnel.accountId': '账户 ID',
  'admin.tunnel.accountIdHint': '在 Cloudflare 控制台网址中查看：dash.cloudflare.com/<账户 ID>。',
  'admin.tunnel.apiToken': 'API 令牌',
  'admin.tunnel.apiTokenHint': '需要具备“账户 → Cloudflare Tunnel → 编辑”权限的令牌。加密存储，之后只显示掩码。',
  'admin.tunnel.tunnelName': '隧道名称',
  ...
  'admin.tunnel.field.api_token': 'API 令牌',
  'admin.tunnel.field.tunnel_name': '隧道名称',
  'admin.tunnel.field.hostname': '公开域名',
  'admin.tunnel.test': '测试连接',
  'admin.tunnel.testOk': '凭据可用{account}',
  'admin.tunnel.existingTunnels': '该账户中已有的隧道：{list}',
  'admin.tunnel.saved': '隧道设置已保存',
  'admin.tunnel.saveError': '无法保存隧道设置',
  'admin.tunnel.loadError': '无法加载隧道设置',
  'admin.tunnel.testError': '连接测试失败',
  'admin.tunnel.copied': '已复制{what}',
  'admin.tunnel.copyError': '无法复制到剪贴板',
  'admin.tunnel.error.disabled': '请先启用此功能。',
  'admin.tunnel.error.missing_token': '请先填写 API 令牌。',
  'admin.tunnel.error.token_has_no_account': '令牌有效，但缺少账户权限。请添加“账户 → Cloudflare Tunnel → 编辑”权限。',
  'admin.tunnel.connectorTitle': '运行连接器',
  'admin.tunnel.provision': '创建隧道',
  'admin.tunnel.reprovision': '重新创建隧道',
  'admin.tunnel.provisioned': '已在 Cloudflare 创建隧道',
  'admin.tunnel.provisionedBadge': '隧道已存在',
  'admin.tunnel.provisionError': '无法创建隧道',
  'admin.tunnel.connectorToken': '连接器令牌',
  ...
  'admin.tunnel.error.no_connector_token': 'Cloudflare 未返回连接器令牌。',
  'admin.tunnel.connectorIntro':
    '连接器不由本应用运行——容器的文件系统是只读的且已丢弃权限。请在下方创建隧道，然后用它给出的令牌以独立进程运行 cloudflared。',
  'admin.tunnel.connectorUnavailable': '请在上方创建隧道以获取连接器命令。',
  'admin.tunnel.envTitle': '还需要在应用容器上设置',
  'admin.tunnel.envIntro':
    '这些位于你的 .env 文件中，应用无法修改。若不设置，邮件链接、日历订阅和 OIDC 登录都会指向错误的地址。',
  'admin.tunnel.envHint':
    'TRUST_PROXY 是应用前面的代理层数：直接接 Cloudflare 填 1，中间还有自己的反向代理则填 2。修改后请重启容器。',
  ...
  'admin.weather.description': 'TT沿用TREK天气API——免费的开源服务，无需 API 密钥。',
