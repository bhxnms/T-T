...
const vacay: TranslationStrings = {
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '與其他 Tourism-Team 使用者共享你的假期計劃',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'Tourism-Team 使用者郵箱',
  ...
  'vacay.inviteHint': '邀請其他 Tourism-Team 使用者共享合併的假期日曆。',
  ...
  'vacay.shareCalendarHint': '讓其他 Tourism-Team 使用者查看你的假期日曆。僅供檢視 — 不合併、不可編輯。',
