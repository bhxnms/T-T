...
const vacay: TranslationStrings = {
  ...
  'vacay.sharing': 'Delen',
  'vacay.sharingHint': 'Deel je vakantieplan met andere Tourism-Team-gebruikers',
  'vacay.owner': 'Eigenaar',
  'vacay.shareEmailPlaceholder': 'E-mail van Tourism-Team-gebruiker',
  ...
  'vacay.inviteHint': 'Nodig een andere Tourism-Team-gebruiker uit om een gecombineerde vakantiekalender te delen.',
  ...
  'vacay.shareCalendarHint':
    'Laat een andere Tourism-Team-gebruiker je vakantiekalender zien. Alleen bekijken — geen fusie, geen bewerking.',
