...
const admin: TranslationStrings = {
  ...
  "admin.amapKey": "AMap Web-Service-sleutel",
  "admin.amapKeyHint": "Voor het zoeken van plaatsen in China en verkeersbewuste routes. Vraag een web-service-sleutel aan op lbs.amap.com.",
