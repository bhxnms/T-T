...
const admin: TranslationStrings = {
  ...
  'admin.weather.description': 'TT continue d\'utiliser l\'API météo de TREK — un service gratuit et open source, sans clé API.',
  ...
  'admin.amapKeyHint':
    'Pour la recherche de lieux en Chine et les itinéraires avec trafic. Obtenez une clé service web sur lbs.amap.com.',
