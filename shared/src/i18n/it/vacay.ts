...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti Tourism-Team',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente Tourism-Team",
  ...
  'vacay.inviteHint': 'Invita un altro utente Tourism-Team a condividere un calendario ferie combinato.',
  ...
  'vacay.shareCalendarHint':
    'Consenti a un altro utente Tourism-Team di vedere il tuo calendario ferie. Sola visualizzazione — nessuna unione, nessuna modifica.',
