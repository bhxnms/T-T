  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        // string here.
        scriptSrc: ["'self'", "'wasm-unsafe-eval'", "'unsafe-eval'", "https://webapi.amap.com", "https://restapi.amap.com", "https://jsapi-service.amap.com"],
        ...
        connectSrc: [
          ...
          "https://restapi.amap.com", "https://webapi.amap.com", "https://*.amap.com", "https://jsapi-service.amap.com", "https://jsapi.amap.com", "https://vdata.amap.com", "https://mvt.amap.com", "https://glyph.amap.com", "https://*.sdf.amap.com",
          // AMap native renderer's documented raster tile shards.
          ...
          // AMap JS API 2D standard raster tiles (browser-side tile shards).
          "https://webrd01.is.autonavi.com", "https://webrd02.is.autonavi.com",
