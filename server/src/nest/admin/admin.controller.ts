...
export class AdminController {
  ...
  @Get('amap-search')
  getAmapSearch() { return this.addons.getAmapSearch(); }
  ...
  updateAmapSearch(@CurrentUser() user: User, @Body() body: AdminFeatureToggleDto, @Req() req: Request) {
    ...
    this.audit.writeAudit({ userId: user.id, action: 'admin.amap_search', ip: getClientIp(req), details: { enabled: result.enabled } });
    return result;
  }
