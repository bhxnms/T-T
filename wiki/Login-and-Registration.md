...
- Otherwise the account is `admin@tt.local`, username `admin`, with a randomly generated password printed to the container log — run `docker logs trek` to retrieve it.
